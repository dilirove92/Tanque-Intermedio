<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormTanquero.aspx.cs" Inherits="ProyectoTanqueIntermedioEpam.CapaPresentacion.FormTanquero" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="style7" 
        ...
        <asp:Label ID="Label1" runat="server" CssClass="style6" 
            ...
            Text="Datos de Tanquero"></asp:Label>
        <hr class="style5" />
        ...
        <div class="style13" style="border: thin groove #C0C0C0">
            ...
            <div class="style17" style="border: thin groove #CC3300">
                ...
                <asp:Label ID="Label11" runat="server" CssClass="style20" Text="Capacidad"></asp:Label>
                <asp:Label ID="Label10" runat="server" CssClass="style19" 
                    Text="Número de Tanquero"></asp:Label>
                <asp:Label ID="Label12" runat="server" CssClass="style21" Text="Marca"></asp:Label>
                <asp:TextBox ID="txtPlaca" runat="server" CssClass="style24" 
                    ontextchanged="txtPlaca_TextChanged"></asp:TextBox>
                <asp:TextBox ID="txtNumTanq" runat="server" CssClass="style25" height="16px" 
                    width="145px"></asp:TextBox>
                <asp:TextBox ID="txtCapacidad" runat="server" CssClass="style26" height="16px" 
                    width="145px"></asp:TextBox>
                <asp:TextBox ID="txtMarca" runat="server" CssClass="style27" height="16px" 
                    width="145px"></asp:TextBox>
            </div>
        </div>
        <strong>
