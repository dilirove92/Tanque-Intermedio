<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormCliente.aspx.cs" Inherits="ProyectoTanqueIntermedioEpam.CapaPresentacion.FormCliente" %>
    ...
    <div class="style7" 
        ...
        <div class="style13" style="border: thin groove #C0C0C0">
            ...
            <div class="style17" style="border: thin groove #CC3300">
                <asp:Label ID="Label9" runat="server" CssClass="style18" Text="Cédula/RUC"></asp:Label>
                ...
                <asp:Label ID="Label12" runat="server" CssClass="style21" Text="Domicilio"></asp:Label>
                <asp:Label ID="Label13" runat="server" CssClass="style22" Text="Teléfono"></asp:Label>
                <asp:TextBox ID="txtCedulaCli" runat="server" CssClass="style24"></asp:TextBox>
                <asp:TextBox ID="txtNombreCli" runat="server" CssClass="style25" height="16px" 
                    width="145px"></asp:TextBox>
                <asp:TextBox ID="txtApellidoCli" runat="server" CssClass="style26" height="16px" 
                    width="145px"></asp:TextBox>
                <asp:TextBox ID="txtDireccionCli" runat="server" CssClass="style27" height="16px" 
                    width="145px"></asp:TextBox>
                <asp:TextBox ID="txtTelefonoCli" runat="server" CssClass="style28" height="16px" 
                    width="145px"></asp:TextBox>
            </div>
        </div>
        <strong>
        <asp:Button ID="btnGuardar" runat="server" CssClass="style33" 
